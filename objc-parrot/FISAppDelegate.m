...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    squawk = [squawk uppercaseString]; /// Creating squak into an upper case variable
    
    NSLog(@"%@", squawk); /// Printing the newly created variable to the Log
    ...
    // Section 3  - Look at me im molting (A)
    ...
    // Section 4  - Look at me im molting (B)
    ...
    // Section 5  - Look at me im molting (C)
