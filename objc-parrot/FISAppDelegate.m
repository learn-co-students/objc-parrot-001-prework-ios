...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Code-Along I
    //Mark A. NSLOG() and the String Leteral
    
    NSLog(@"Squark!");
    NSLog(@"%@", @"Squark!");
    NSLog(@"%@!", @"Squark");
    NSLog(@"%@!", [@"Squark" uppercaseString]);
    
    
    //Mark B. NSString variable
    
    NSString *squark = @"squark";
    NSLog(@"%@", squark);
    
    squark = [squark uppercaseString];
    NSLog(@"%@", squark);
    
    squark = [squark stringByAppendingString:@"!"];
    NSLog(@"%@", squark);
    ...
    //Mark B. Interpolate muliple strings into a string variable
    NSString *windInYerSails = [NSString stringWithFormat:@"%@ %@ %@ %@!", wind, inString, yer, sails];
    NSLog(@"%@", windInYerSails);
    
    //Building a string by Concetaning Substrings
    NSLog(@"%@", wind);
